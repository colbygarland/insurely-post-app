<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->email == 'colbygarland@gmail.com' || auth()->user()->email == 'colbyg@insurely.ca' || auth()->user()->email == 'christineb@insurely.ca' || auth()->user()->email == 'kateb@insurely.ca')
