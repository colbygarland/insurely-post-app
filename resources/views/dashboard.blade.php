    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg mb-16 p-6">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-4">To Do</h2>
                <ul class="list-disc pl-8">
                    <li>Tag the person + company in the Quote</li>
                    <li>Set up a cron job to pull in WP posts and then post new ones to LI</li>
                </ul>
            </div>
            ...
            @endif
            <div class="bg-white shadow-sm sm:rounded-lg mb-16 p-6">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-4">Test Playground</h2>
                <a href="/company-lookup?company=Insight Mortgage" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">Company Search</a>
            </div>
            <div class="bg-white shadow-sm sm:rounded-lg mb-16 p-6">
