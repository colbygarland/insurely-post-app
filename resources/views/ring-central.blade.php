                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 dark:text-gray-200">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Call Type</th>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if(!$callLog->transcription && !$callLog->summary && !$callLog->analysis)
                                                <div class="relative group">
                                                    ...
                                                    <div class="absolute text-center bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                                                        Calls less than {{ \App\Http\Controllers\CallLogController::$minimumDuration / 60 }} mins or longer than {{ \App\Http\Controllers\CallLogController::$maximumDuration / 60 }} minutes are not automatically transcribed. 
                                                        <br/>
                                                        You can still manually generate the transcript and analysis! 
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
